...
#define rTICNT0    (*(volatile unsigned char *)0x57000044)	//Tick time count
#define rTICNT1    (*(volatile unsigned char *)0x5700004C)
#define rTICNT2    (*(volatile unsigned char *)0x57000048)
...
#define rTICKCNT   (*(volatile unsigned char *)0x57000090)
#endif  //RTC
