...
void MMU_Init(void)
{
	...
	MMU_SetMTT(0x32000000,0x33700000,0x32000000,RW_CB);  //bank6-2, TEST DATA,LCD FrameBuffer
	MMU_SetMTT(0x33800000,0x33e00000,0x33800000,RW_NCNB);  //bank6-2, TEST DATA,LCD FrameBuffer
